...
public class BoardController extends AbstractController<Board> {
	...
	@GetMapping("/brdWrtDate/{brdWrtDate}")
	public ResponseEntity<List<Board>> findByBrdWrtDate(@PathVariable String brdWrtDate) {
		return ResponseEntity.ok(service.findByBrdWrtDate(brdWrtDate));
	}
}